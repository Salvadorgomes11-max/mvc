...
class ModelUser extends Model {
    ...
    public function updateUser(int $id, string $pseudo, string $email, string $password, string $created_at) : bool {
        $req = $this->getDb()->prepare('UPDATE user SET pseudo = :pseudo, email = :email, password = :password, created_at = :created_at 
        WHERE id = :id');
        $req->bindParam(':id', $id, PDO::PARAM_INT);
